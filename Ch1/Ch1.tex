...
Field Creation: The gravitational potential $\Phi$ is related to the mass density $\rho$ by Poisson's equation:
...
\begin{wrapfigure}{l}{0.55\textwidth}
  ...
  \begin{minipage}{0.48\linewidth}
    \includesvg[width=\linewidth]{LightCone.svg}
  \end{minipage}
  \hfill
  \begin{minipage}{0.48\linewidth}
    \includesvg[width=\linewidth]{WorldlineCones.svg}
  \end{minipage}
...
\end{equation}
Here is the LaTeX code for Section 1.6, formatted to match your document's style.
